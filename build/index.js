...
function createCollabServer() {
    ...
    server.tool("collab-bootstrap", "Invoke the Collaborator persona. Returns a synthesized context payload: who the Collaborator is, who the user is, what they're working on, current goals, active tensions, and recent context. Call this first when using /collab.", {}, async () => {
